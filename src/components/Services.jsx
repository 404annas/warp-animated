...
const services = [
  {
    ...
    img: "https://images.unsplash.com/photo-1584224549374-995cbac1ab62?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8dmlkZW8lMjBwcm9kdWN0aW9ufGVufDB8fDB8fHww"
  },
  {
    ...
    img: "https://images.unsplash.com/flagged/photo-1575290319880-014c6eba06b6?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8dmlkZW8lMjBkaXJlY3Rpb258ZW58MHx8MHx8fDA%3D"
  },
  {
    ...
    img: "https://plus.unsplash.com/premium_photo-1682146717223-874ac7dcc607?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8dmlkZW8lMjBmaWxtaW5nfGVufDB8fDB8fHww"
  },
  {
    ...
    img: "https://media.istockphoto.com/id/1055293068/photo/movie-night-at-back-yard.webp?a=1&b=1&s=612x612&w=0&k=20&c=k5xDStCyGAglErDNvuAAUpnHEk4VMdGd4HKn1Fqsl-k="
  }
];
          ...
          <motion.div className='flex  justify-between items-center absolute z-10 inset-0 w-[600vw] ' style={{ x }}>
            {services.map((service, i) => (
              <div key={i} className='w-[330px]'>
                ...
                <h1 className='text-7xl leading-16 mb-4 font-bold text-[#F5F5F5]'>
                  {service.title}
                </h1>
