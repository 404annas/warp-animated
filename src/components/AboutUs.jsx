        ...
        >
          <p className="pb-4">
            ...
            <a
              ...
              href="https://www.imdb.com/title/tt2400629/?ref_=nm_ov_bio_lk"
            >
            ...
            <a
              className="text-[#aaaaaa]"
              href="https://www.imdb.com/title/tt9373234/?ref_=nm_ov_bio_lk"
            >
              Laal Kabootar (2019)
            </a>{" "}
            and{" "}
            <a
              className="text-[#aaaaaa]"
              href="https://www.imdb.com/title/tt37937230/?ref_=nm_ov_bio_lk"
            >
              Faltu Pyar (2022)
            </a>
            .
          </p>
          My work as a video producer and director includes projects with
          artists such as Hasan Raheem, Natasha Noorani, Talha Anjum, Talha
          Yunus, Quick Style,Nayel, Faris Shafi and HYDR among others. voices
          shaping the cutting edge of South Asian music.
          <p className="pt-4">
            My Productions for Pepsi’s ‘Why Not Meri Jaan’ and ‘Sohna Tu’
            redefined the brand’s identity for Gen Z, merging music, fashion,
            and rebellion into high-impact digital storytelling.
          </p>
        </motion.p>
      </motion.div>
